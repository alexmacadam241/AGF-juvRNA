---
title: "9.1_aten_juv_host_mixOmics_sPLS-DA"
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics.rds")
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics2.rds")
tune.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics2.rds")
...
pdf(file = "/Users/alexmacadam/Desktop/trial_Plot.pdf", width = 6, height = 6)
# generate the CIM, using the legend and colouring rows by each sample's class
cim <- cim(final.splsda, comp = 1, row.sideColors = color.mixo(y), 
           legend = legend, cluster = "row")
dev.off()
...
cim.res <- cim(final.splsda, row.sideColors = color.mixo(y), 
           ...
           cluster = "row",
           save = 'jpeg', name.save = '/Users/alexmacadam/Desktop/PLS_CIM_image')
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics3.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1_aten_host_mixomics3.rds")
