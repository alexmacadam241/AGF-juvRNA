---
title: "9.1.5_aten_juv_host_mixOmics_sPLS-DA-hot"
...
#filter coldata
coldata <- coldata |> filter(Temp == "Hot")
...
hot_samples<- coldata2 |> filter(Temp == "Hot") |> pull(Samples)
```
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.5_aten_host_mixomics_hot.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.5_aten_host_mixomics_hot.rds")

# plot the outcome of performance evaluation across all ten components
plot(perf.splsda.srbct,  sd = TRUE,
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.5_aten_host_mixomics2_hot.rds")
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.5_aten_host_mixomics3_hot.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.5_aten_host_mixomics3_hot.rds")
