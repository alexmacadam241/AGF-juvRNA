---
title: "9.3_aten_juv_symbSS_mixOmics_sPLS-DA"
...
#remove outlier
#coldata <- coldata %>% filter(Sample.ID != "JA22115.J8xP5.C29.Hot.SS.T11.ID2R")
...
coldata<- coldata |> dplyr::filter(Symbiont == "SS")
...
Get Count Data
```{r}
x<- as.matrix(read.csv("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Data/Gene_counts/count_tables/Juvenile_symbiont/aten_juveniles_symb_Cgor_counts.csv", row.names = 1))
...
Cross <- as.factor(c("J8xJ3", "J8xJ2", "J8xJ2", "J8xJ2", "J8xD6", "J8xJ2", "J8xJ3", "J8xD1", "J8xJ2", "J8xJ2", "J8xJ3", "J8xD13", "J8xD13", "J8xJ3", "J8xD1", "J8xD13", "J8xD1", "J8xD1", "J8xD6", "J8xD6", "J8xD13", "J8xD13", "J8xD6", "J8xD6", "J8xJ3", "J8xD6", "J8xD1", "J8xD13", "J8xP5", "J8xP5", "J8xP5", "J8xP5"))
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/9.3_aten_host_mixomics.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/9.3_aten_host_mixomics.rds")
...
tune.splsda.srbct <- tune.splsda(x, y, ncomp = 3, # calculate for first 2 components
                                 validation = 'Mfold',
                                 folds = 10, nrepeat = 100, # use repeated cross-validation
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.3_aten_host_mixomics2.rds")
tune.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.3_aten_host_mixomics2.rds")

plot(tune.splsda.srbct, col = color.jet(3)) # plot output of variable number tuning
```
...
```{r}
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/splsda_SS_1.pdf", width = 5, height = 4)
...
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/splsda_SS_2.pdf", width = 5, height = 4)
...
cim.res <- cim(final.splsda, row.sideColors = color.mixo(y), 
           ...
           cluster = "row",
           save = 'jpeg', name.save = '/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/SS_PLS_CIM_image')
```
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.3_aten_SS_mixomics3.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.3_aten_SS_mixomics3.rds")

# plot the stability of each feature for the first three components, 'h' type refers to histogram
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/loading_SS_1.pdf", width = 30, height = 10)
par(mfrow=c(2,1))
...
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/circ_SS_1.pdf", width = 5, height = 4)
plotVar(final.splsda, comp = c(1,2), 
        #var.names = list(var.name.short), 
        cex = 3) # generate correlation circle plot
dev.off()

pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/sym_sPLS-DA/circ_SS_2.pdf", width = 5, height = 4)
