...
dfX <- data.frame(comp1 = 35, comp2 = 35)
dfX <- data.frame(comp1 = 10, comp2 = 10)
...
final.spls.liver <- spls(x1, x2, ncomp = optimal.ncomp, 
                         keepX = optimal.keepX,
                         keepY = optimal.keepY,
                         mode = "regression") # explanitory approach being used, 
# hence use regression mode
saveRDS(final.spls.liver, file = "10.2.2_aten_juv_final_sPLS.rds")
...
pdf("final_spls_liver_network.pdf", width = 10, height = 10)
