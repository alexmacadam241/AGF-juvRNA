---
title: "9.1.2_aten_juv_host_mixOmics_sPLS-DA-D1"
...
#filter coldata
coldata <- coldata |> filter(Symbiont == "D1")
...
# Subset to include only columns containing "_D1_"
x <- x[, grep("_D1_", colnames(x))]
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics_D1.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics_D1.rds")
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics2_D1.rds")
tune.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics2_D1.rds")
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics3_D1.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.2_aten_host_mixomics3_D1.rds")
...
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/Amb splsda/D1_heat.pdf", width = 6, height = 6)
...
cim.res <- cim(final.splsda, row.sideColors = color.mixo(y), 
           ...
           cluster = "row",
           save = 'jpeg', name.save = '/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/Amb splsda/D1_heat2.pdf')
