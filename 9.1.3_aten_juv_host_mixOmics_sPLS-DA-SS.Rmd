---
title: "9.1.3_aten_juv_host_mixOmics_sPLS-DA-SS"
...
#filter coldata
coldata <- coldata |> filter(Symbiont == "SS")
...
# Subset to include only columns containing "_SS_"
x <- x[, grep("_SS_", colnames(x))]
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics_SS.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics_SS.rds")
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics2_SS.rds")
tune.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics2_SS.rds")
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics3_SS.rds")
perf.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.3_aten_host_mixomics3_SS.rds")
...
pdf(file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Figures/Juveniles/Symbiont comparison/Amb splsda/SS_heat.pdf", width = 6, height = 6)
