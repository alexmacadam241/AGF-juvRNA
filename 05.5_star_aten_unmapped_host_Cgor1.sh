#!/bin/bash
#PBS -o 05.5_star_aten_unmapped_host_Cgor1.2.sh.log
#PBS -e 05.5_star_aten_unmapped_host_Cgor1.2.sh.err
...
###I map porites reads that did no map to the host, to UQ Cladocopium goreaui.

# Setting up input directory
INPUT_DIR=/home/jc828813/RNAseq/results/aten_juveniles/host/mapping/SS
...
qsub -v PBSDATASET="$DATASET" /home/jc828813/RNAseq/scripts/05.5_star_aten_unmapped_host_Cgor1.2.pbs
done