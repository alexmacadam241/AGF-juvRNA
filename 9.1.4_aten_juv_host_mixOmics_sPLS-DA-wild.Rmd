---
title: "9.1.4_aten_juv_host_mixOmics_sPLS-DA-wild"
...
#filter coldata
coldata <- coldata |> filter(Symbiont == "Wild")
...
# Subset to include only columns containing "_Wild_"
x <- x[, grep("_Wild_", colnames(x))]
...
#saveRDS(tune.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.4_aten_host_mixomics2_Wild.rds")
tune.splsda.srbct<- readRDS("/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.4_aten_host_mixomics2_Wild.rds")
...
#saveRDS(perf.splsda.srbct, file = "/Users/alexmacadam/Dropbox/PhD/Chapter4_RNA/Scripts/Codes for RNAseq analysis/9.1.4_aten_host_mixomics3_Wild.rds")
