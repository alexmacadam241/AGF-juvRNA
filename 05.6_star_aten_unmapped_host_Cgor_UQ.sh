#!/bin/bash
#PBS -o 05.6_star_aten_unmapped_host_Cgor_UQ.log
#PBS -e 05.6_star_aten_unmapped_host_Cgor_UQ.err
...
qsub -v PBSDATASET="$DATASET" /home/jc828813/RNAseq/scripts/05.6_star_aten_unmapped_host_Cgor_UQ.pbs
done