...
###I map porites reads that did no map to the host, to C. gor.
...
qsub -v PBSDATASET="$DATASET" /home/jc828813/RNAseq/scripts/05.7.2_star_aten_unmapped_host_Wild_Cgor_UQ.pbs
done