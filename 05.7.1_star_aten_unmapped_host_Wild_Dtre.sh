...
###I map porites reads that did no map to the host, to Durusdinium trenchii.

# Setting up input directory
INPUT_DIR=/home/jc828813/RNAseq/results/aten_juveniles/host/mapping/Wild
...
qsub -v PBSDATASET="$DATASET" /home/jc828813/RNAseq/scripts/05.7.1_star_aten_unmapped_host_Wild_Dtre.pbs
done